...
public class DbOperator{
	...
	public void writeSql(String pid,String pname,int ip,int sp,int cure,int dead,java.util.Date d){
		SimpleDateFormat ft = new SimpleDateFormat ("yyyy-MM-dd");
		String dStr=ft.format(d);
		Statement stm;
		String sqlstr="insert into "+daName+" value("+pid+",'"+pname+"',"+ip+","+sp+","+cure+','+dead+",'"+dStr+");";
		try {
			stm=conn.createStatement();
